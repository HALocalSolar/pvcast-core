...
CONF_PATH = Path(__file__).parent / "configs"
TEST_CONF_STRING_PATH = CONF_PATH / "test_config_string.yaml"
TEST_CONF_ERR = CONF_PATH / "test_config_error.yaml"
TEST_CONF_MISSING = CONF_PATH / "test_config_missing.yaml"
TEST_CONF_MALFORMED = CONF_PATH / "test_config_malformed.yaml"
